module Svg.Styled.Axis exposing
...
import Svg.Styled exposing (Svg, g, line, text, text_)
import Svg.Styled.Attributes as Attrs exposing (class, d, dy, fill, fontFamily, fontSize, stroke, textAnchor, transform)
...
element { x, y, x1, x2, y1, y2, translate, horizontal } k displacement textAnchorPosition =
    \attrs scale ->
        ...
        g [ fill "none", fontSize "10", fontFamily "sans-serif", textAnchor textAnchorPosition ]
            (Svg.Styled.path [ class "domain", stroke "#000", d domainLine ] []
